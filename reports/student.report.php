...
$q = "SELECT tbl_student.*, tbl_branch.address AS baddress
	FROM tbl_student,tbl_branch
	WHERE tbl_student.branchId = tbl_branch.branchId
...
<html>
<head>
	<title>Student Report | TMS</title>
	<!-- jQuery -->
...
<body>
	<div class="container mb-3 mt-3">
		<div class="row">
			<div class="col-md-12">
				<p class="display-4" style="font-size: 3.5rem;">Student Report</p>
			</div>
		</div>
						...
						<tbody>
							<?php
								...
								foreach ($result as $row) {
									...
									echo'<td title="'.$row['studentId'].'">'.$row['name'].'</td>';
