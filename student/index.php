...
<style type="text/css">
  ...
  ?>
    ...
    <section class="ftco-section">
        ...
        <div class="row">
          <div class="col-md-4 col-xs-12 offset-md-4 align-self-stretch ftco-animate">
            <div class="media block-6 services p-3 py-4 d-block text-center">
              ...
              <div class="media-body px-3" id="notice_board">
        ...
        <!--row attendance-->
        <div class="row">
          <div class="col-md-4 offset-md-4 align-self-stretch ftco-animate">
            <div class="media block-6 services p-3 py-4 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center mb-3 bg-info"><span class="fa fa-calendar" style="color: white;"></span></div>
              <div class="media-body px-3">
                <h3 class="heading" id="attendence">Attendance</h3>
                <p>You remained Present in this Month</p>
                <hr/>
              </div>
            </div>    
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 offset-md align-self-stretch ftco-animate">
            <div class="media block-6 services p-3 py-4 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center mb-3 bg-info"><span class="flaticon-exam" style="color: white;"></span></div>
              <div class="media-body px-3">
                <h3 class="heading">Marks</h3>
        ...
        <div class="row">
          <div class="col-md-4 offset-md-4 align-self-stretch ftco-animate">
            <div class="media block-6 services p-3 py-4 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center mb-3 bg-info"><span class="fas fa-rupee-sign" style="color: white;"></span></div>
              <div class="media-body px-3" id="fees_receipt_box">
                <h3 class="fees_receipt">Fees Details</h3>
                Total Fees <?php echo $student['totalFees'];?><br/>
                You Paid <?php echo $student['paidFees'];?>
              </div>
              <hr>
            </div>      
          </div>
