...
$branchId = str_replace("-", "#", $_GET['branchId']);
...
$q = "SELECT * FROM tbl_staff WHERE branchId LIKE '$branchId'";
    ...
    <section class="ftco-section bg-light">
      <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Our Experience Staff</h2>
          </div>
        </div>
        <div class="row text-center" id="staff_display">
            <?php 
        	...
        	<div class="col-lg-4 mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(../images/staff/<?php echo $staff['photo']; ?>);"></div>
        				<div class="info ml-4">
        					<h3><a href="teacher-single.html"><?php echo $staff['name']; ?></a></h3>
        					<span class="position"><?php echo $staff['qualification']; ?></span>
        				</div>
        			</div>
        			<div class="text">
