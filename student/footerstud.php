<style type="text/css">
  .social-media-list {
    ...
    #fh5co-footer .fh5co-footer-links li a:hover {
     ...
     #fh5co-footer .fh5co-footer-links li a span:hover {
      color:white;
    }
  ...
  <div class="container">
    <div class="row row-pb-md">
     <!--  <div class="col-md-4 fh5co-widget">
      ...
      <div class="col-md-8 offset-md-2 fh5co-widget">
        <div class="row" >
          <div class="col-md-4 col-sm-4 col-xs-6 fh5co-widget">
            ...
            <ul class="fh5co-footer-links">
              ...
              <!-- <li><a href="change_pwd.php" target="">Change Password</a></li> -->
            </ul>
          </div>
            ...
            <ul class="fh5co-footer-links">
              <li>
                <a href="#"><span class="fa fa-map-marker fa-1x"></span>
                  <span class="text">  &nbsp; &nbsp; <?php echo$tution['city'];?> | Gujarat</span>
                </a>
              </li>
              <li>
                <a href="#"><span class="fa fa-phone fa-1x"></span>
                  <span class="text">&nbsp; &nbsp;+91 <?php echo$tution['phone'];?></span>
                </a>
              </li>
              <li>
                <a href="#">
                  <span class="fa fa-envelope fa-1x"></span>
                  <span class="text">&nbsp; &nbsp;<?php echo$tution['email'];?></span>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-6">
            <p class="float-right"><span class=" fas fa-arrow-up" style="font-size: 20px; color: darkgrey;"></span><a href="index.php" style="color: darkgrey; font-size: 20px; ">&nbsp; Back to top</a></p>
          </div>  
        </div>
      </div>
    </div>
